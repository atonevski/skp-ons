...
var dailyNext, dailyPrev, moonPhaseIcon, moonPhaseIconAlt, renderDaily;
...
moonPhaseIconAlt = function(v) { // v: 0..1
  v = Math.floor(28 * v);
  switch (false) {
    case v !== 0:
      return 'wi-moon-alt-new';
    case !((0 < v && v < 7)):
      return `wi-moon-alt-waxing-crescent-${v}`;
    case v !== 7:
      return 'wi-moon-alt-first-quarter';
    case !((7 < v && v < 14)):
      return `wi-moon-alt-waxing-gibbous-${v - 7}`;
    case v !== 14:
      return 'wi-moon-alt-full';
    case !((14 < v && v < 21)):
      return `wi-moon-alt-waning-gibbous-${v - 14}`;
    case v !== 21:
      return 'wi-moon-alt-third-quarter';
    case !((21 < v && v < 28)):
      return `wi-moon-alt-waning-crescent-${v - 21}`;
    default:
      return "wi-na";
  }
};

...
latlngs = [ //0: Бутел
  ...
  [
    ...
    [
      41.99385763206613,
      21.448567600505104 //4: Ѓорче Петров
    ]
  ],
  [
    [42.0104374739155,
  ...
  [
    ...
    [
      41.99148042888061,
      21.423517942084803 //6: Кисела Вода
    ]
  ],
  [
    [41.987405225853784,
  ...
  [
    ...
    [
      41.97580100508219,
      21.501520568642285 //8: Автокоманда+Железара+Ченто
    ]
  ],
  [
    [41.99702382087668,
    ...
    [
      41.99702382087668,
      21.529375076424913 //9: Маџари+Хиподром
    ]
  ],
  [
    [41.993313990077745,
    ...
    [
      41.985918729384345,
      21.510715484619144 //10: Бардовци
    ]
  ],
  [
    [42.00900286039821,
  ...
  [
    ...
    [
      41.99142044005076,
      21.550346123406353 //13: Миладиновци
    ]
  ],
  [[41.98923749037232,
  21.647618456865054],
...
window.fn.loadPlay = function() {
  ...
  content = $('#content')[0];
  menu = $('#menu')[0];
  if (window.fn.selected === 'measurements') {
    menu.close.bind(menu)();
    return;
  }
  return content.load('views/play.html').then(menu.close.bind(menu)).then(function() {
    return renderPlay();
  });
};
...
renderPlay = function() {
  var CENTER, CITY, PASSWORD, USERNAME, getLast24h, getSensors, parsePos, renderMap, toDTM;
  ...
  getLast24h = function() {
    ...
    url = `https://${CITY}.pulse.eco/rest/dataRaw?` + "type=pm10&" + `from=${encodeURIComponent(toDTM(from))}&` + `to=${encodeURIComponent(toDTM(to))}`;
    return $.ajax({
      url: url,
      method: 'GET',
      username: USERNAME,
